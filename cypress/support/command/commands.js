Cypress.Commands.add(
  "html5DnD",
  (fromEl, toEl, { payload = "Chart", steps = 6 } = {}) => {
    ...
    for (let i = 1; i <= steps; i++) {
      ...
      fire(doc.elementFromPoint(x, y) || doc.body, "dragover", {
        clientX: x,
        clientY: y,
      });
    }
    ...
    // ✅ yield a boolean (not a plain return)
    return cy.wrap(dropEv.defaultPrevented, { log: false });
  }
);
